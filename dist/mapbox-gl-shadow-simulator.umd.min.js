(function (global, factory) {
  ...
  ((i.prototype = {
    ...
    (s.prototype = {
      ...
      contains: function (t) {
        ...
        return (
          (t =
            "number" == typeof t[0] || t instanceof i ? a(t) : u(t)) instanceof
          s
            ? ((e = t.min), (r = t.max))
            : (e = r = t),
          e.x >= this.min.x &&
    ...
    (l.prototype = {
      ...
      contains: function (t) {
        t =
          "number" == typeof t[0] || t instanceof f || "lat" in t ? d(t) : h(t);
        var e,
          r,
          o = this._southWest,
          i = this._northEast;
  ...
  function R(t, e) {
    ...
    do {
      if (
        ((r = false),
        o.steiner || (!z(o, o.next) && 0 !== O(o.prev, o, o.next)))
      )
        o = o.next;
      else {
  ...
  class ShadeMapBase extends EventEmitter {
    constructor(...e) {
      ...
      const r = e[0];
      if (
        ((this.options = Object.assign(this.options, r)), !this.options.apiKey)
      )
              ...
              return new Promise((t, l) => {
                ...
                (this.inProgress.push(c),
                  (c.onload = () => {
                    ...
                    const s = e.filter(
                        (t) =>
                          r === u(ht({ tile: t, maxZoom: f, tileSize: h })),
                      ),
